...
const int moveInterval = 120; // Snake speed in ms

#define GRID_W 30 // 240px / 8px
#define GRID_H 13 // 104px / 8px (Play area Y: 16 to 119)
#define CELL_SIZE 8
#define Y_OFFSET 16
...
void startSnakeGame() {
    ...
    snakeBody.clear();
    snakeBody.push_back({10, 6});
    snakeBody.push_back({9, 6});
    snakeBody.push_back({8, 6});
...
void drawSnakeGame() {
    ...
    // Game Sub-Header
    canvas.fillRect(0, 14, 240, 13, DARK_PURPLE);
